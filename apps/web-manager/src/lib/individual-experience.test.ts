...
describe("individual experience", () => {
  ...
  it("hides enterprise dashboard paths in individual mode", () => {
    ...
    expect(isDashboardPathHiddenInIndividualExperience("/dashboard/leases/lease_1/move-out")).toBe(false);
    expect(isDashboardPathHiddenInIndividualExperience("/dashboard/move-outs")).toBe(false);
