            ...
            <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 space-y-3">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-3 rounded-2xl bg-black px-4 py-4 text-sm font-semibold text-white transition hover:bg-slate-800"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-3 rounded-2xl bg-[#0063FE] px-4 py-4 text-sm font-semibold text-white transition hover:bg-[#0052d4]"
                >
                  <svg className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
