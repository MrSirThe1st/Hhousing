      ...
      <div className="mx-auto flex max-w-7xl flex-col items-stretch justify-between gap-5 px-4 sm:flex-row sm:items-center sm:px-6 lg:px-10">
        ...
        <div className="flex w-full flex-col gap-2.5 sm:w-auto sm:flex-row sm:flex-wrap sm:items-center sm:gap-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-[#25D366] px-5 text-sm font-semibold text-white transition hover:bg-[#1ebe57] sm:w-auto"
          >
