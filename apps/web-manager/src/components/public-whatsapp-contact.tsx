...
export default function PublicWhatsAppContact(): React.ReactElement {
  ...
  return (
    <section id="contact" className="border-y border-slate-200 bg-white py-10 md:py-12">
      <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-5 px-6 sm:flex-row sm:items-center lg:px-10">
        <div className="max-w-xl">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#25D366]">WhatsApp</p>
          <h2 className="mt-2 text-xl font-bold tracking-tight text-[#010A19] sm:text-2xl">
            Une question ? Écrivez-nous sur WhatsApp
          </h2>
          <p className="mt-1.5 text-sm text-slate-600 sm:text-base">
            Réponse rapide pour une démo, un devis ou un besoin de migration.
          </p>
        </div>
        <div className="flex flex-wrap items-center gap-3">
          {whatsappUrl ? (
            <a
              ...
              className="inline-flex h-11 items-center justify-center gap-2 rounded-lg bg-[#25D366] px-5 text-sm font-semibold text-white transition hover:bg-[#1ebe57]"
            >
            ...
            <a
              ...
              className="inline-flex h-11 items-center justify-center gap-2 rounded-lg bg-[#0063FE] px-5 text-sm font-semibold text-white transition hover:bg-[#0052d4]"
            >
              Écrire à {email}
            </a>
          )}
